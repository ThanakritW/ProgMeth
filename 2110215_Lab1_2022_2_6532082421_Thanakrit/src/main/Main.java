...
public class Main {
	...
	public static void main(String[] args) throws NumberFormatException, NameBlankException {
		setUp();
		showMainMenu();
	}
	...
	public static void showMainMenu() throws NumberFormatException, NameBlankException {
	...
	public static void showAddItemFromFile() throws NumberFormatException, NameBlankException {
		System.out.println("========================================");
